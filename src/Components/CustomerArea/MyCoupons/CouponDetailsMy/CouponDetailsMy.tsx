...
import "./CouponDetailsMy.css";

//This component receives a coupon and displays its details
function CouponDetailsMy(): JSX.Element {
    ...
    return (
        <div className="CouponDetailsMy box details">
...
export default CouponDetailsMy;
