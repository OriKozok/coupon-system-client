...
import CouponModel from "../../../../Models/CouponModel";import "./CouponCardMy.css";
...
function CouponCardMy(props: CouponProps): JSX.Element {
    return (
        <Link to={"/customer/coupons/my/"+props.coupon.id}>
        <div className="CouponCardMy box">
            <div>
